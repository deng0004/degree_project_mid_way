...
const alcElement = document.getElementById("alc");
const coElement = document.getElementById("co");
const h2Element = document.getElementById("h2");
const lpgElement = document.getElementById("lpg");
  ...
  if (user) {
    ...
    chartRef.on('value', snapshot =>{
      ...
      dbRef.orderByKey().limitToLast(chartRange).on('child_added', snapshot =>{
        ...
        var Alc = jsonData.Alc;
        var CO = jsonData.CO;
        var H2 = jsonData.H2;
        var LPG = jsonData.LPG;
        var Prop = jsonData.Prop;
        ...
        console.log("alc type", typeof (Alc));
    ...
    dbRef.orderByKey().limitToLast(1).on('child_added', snapshot =>{
      ...
      var timestamp = jsonData.timestamp;
      // Update DOM elements
      alcElement.innerHTML = Alc;
      coElement.innerHTML = CO;
      h2Element.innerText = H2;
      lpgElement.innerText = LPG;
